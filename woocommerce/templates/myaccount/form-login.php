    ...
    <div class="bw-account-login">
        ...
        <div class="bw-account-login__content-wrapper">
            <div class="bw-account-login__content">
                ...
                <div class="bw-account-provider" data-bw-provider-default="<?php echo esc_attr( $login_provider ); ?>">
                    <div class="bw-account-provider__tabs" role="tablist" aria-label="<?php esc_attr_e( 'Login providers', 'bw' ); ?>">
                        <button class="bw-account-provider__tab <?php echo 'wordpress' === $login_provider ? 'is-active' : ''; ?>" type="button" data-bw-provider-tab="wordpress" role="tab" aria-selected="<?php echo 'wordpress' === $login_provider ? 'true' : 'false'; ?>">
                            <?php esc_html_e( 'Login with WordPress', 'bw' ); ?>
                        </button>
                        <button class="bw-account-provider__tab <?php echo 'supabase' === $login_provider ? 'is-active' : ''; ?>" type="button" data-bw-provider-tab="supabase" role="tab" aria-selected="<?php echo 'supabase' === $login_provider ? 'true' : 'false'; ?>">
                            <?php esc_html_e( 'Login with Supabase', 'bw' ); ?>
                        </button>
                    </div>

                    <div class="bw-account-provider__panels">
                        <div class="bw-account-provider__panel <?php echo 'wordpress' === $login_provider ? 'is-active is-visible' : ''; ?>" data-bw-provider-panel="wordpress" role="tabpanel">
                        ...
                        <div class="bw-account-provider__panel <?php echo 'supabase' === $login_provider ? 'is-active is-visible' : ''; ?>" data-bw-provider-panel="supabase" role="tabpanel">
                            <form class="bw-account-login__form bw-account-login__form--supabase" data-bw-supabase-form>
