...
function bw_site_render_checkout_tab() {
    ...
    if ( isset( $_POST['bw_checkout_settings_submit'] ) ) {
        ...
        $page_bg              = isset( $_POST['bw_checkout_page_bg_color'] ) ? sanitize_hex_color( wp_unslash( $_POST['bw_checkout_page_bg_color'] ) ) : '';
        $grid_bg              = isset( $_POST['bw_checkout_grid_bg_color'] ) ? sanitize_hex_color( wp_unslash( $_POST['bw_checkout_grid_bg_color'] ) ) : '';
        ...
        update_option( 'bw_checkout_page_bg_color', $page_bg );
        update_option( 'bw_checkout_grid_bg_color', $grid_bg );
    ...
    $page_bg             = get_option( 'bw_checkout_page_bg_color', '#ffffff' );
    $grid_bg             = get_option( 'bw_checkout_grid_bg_color', '#ffffff' );
    ...
    <form method="post" action="">
        ...
        <table class="form-table" role="presentation">
            ...
            <tr>
                <th scope="row">
                    <label for="bw_checkout_page_bg_color">Checkout Page Background</label>
                </th>
                <td>
                    <input type="text" id="bw_checkout_page_bg_color" name="bw_checkout_page_bg_color" value="<?php echo esc_attr( $page_bg ); ?>" class="bw-color-picker" data-default-color="#ffffff" />
                    <p class="description">Colore di sfondo della pagina checkout (body/wrapper).</p>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="bw_checkout_grid_bg_color">Checkout Grid Background</label>
                </th>
                <td>
                    <input type="text" id="bw_checkout_grid_bg_color" name="bw_checkout_grid_bg_color" value="<?php echo esc_attr( $grid_bg ); ?>" class="bw-color-picker" data-default-color="#ffffff" />
