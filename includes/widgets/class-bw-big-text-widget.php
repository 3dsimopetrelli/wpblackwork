...
class BW_Big_Text_Widget extends Widget_Base {
	...
	public function get_style_depends() {
		...
		return array( 'bw-big-text-style' );
	}
	...
	private function register_style_controls() {
		...
		BW_Widget_Helper::add_typography_group(
			$this,
			'text_typography',
			'{{WRAPPER}} .bw-big-text__content',
			array(
				'exclude'        => array( 'font_size', 'line_height', 'letter_spacing' ),
	...
	private function build_editorial_line_groups( string $content ): array {
		$raw_lines   = preg_split( '/\R+/u', $content ) ?: array();
		$line_groups = array();
