...
class BW_Button_Widget extends Widget_Base {
	...
	public function get_style_depends() {
		...
		return array( 'bw-button-style' );
	}

	public function get_script_depends() {
		return wp_script_is( 'bw-button-script', 'registered' ) ? array( 'bw-button-script' ) : array();
	}
	...
	private function prepare_button_style_data( array $settings ) {
		...
		$padding        = isset( $settings['button_padding'] ) && is_array( $settings['button_padding'] ) ? $settings['button_padding'] : array();
	...
	private function get_icon_markup( array $settings ) {
		$custom_icon = isset( $settings['custom_icon'] ) ? (array) $settings['custom_icon'] : array();
		$icon_html   = '';
