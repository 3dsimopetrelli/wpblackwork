...
class Widget_Bw_Static_Showcase extends Widget_Base {
	...
	public function get_style_depends() {
		return array( 'bw-static-showcase-style' );
	}

	public function get_script_depends() {
		return array( 'bw-static-showcase-script' );
	}
	...
	private function register_style_controls() {
		...
		BW_Widget_Helper::add_typography_group( $this, 'title_typography', '{{WRAPPER}} .bw-slide-showcase-content .bw-title' );

		BW_Widget_Helper::add_dimensions_control( $this, 'title_padding', __( 'Padding', 'bw-elementor-widgets' ), '{{WRAPPER}} .bw-slide-showcase-content .bw-title', 'padding', array( 'px', '%', 'em', 'rem' ) );
		...
		BW_Widget_Helper::add_typography_group( $this, 'subtitle_typography', '{{WRAPPER}} .bw-slide-showcase-content .bw-subtitle' );

		BW_Widget_Helper::add_dimensions_control( $this, 'subtitle_padding', __( 'Padding', 'bw-elementor-widgets' ), '{{WRAPPER}} .bw-slide-showcase-content .bw-subtitle', 'padding', array( 'px', '%', 'em', 'rem' ) );
		...
		BW_Widget_Helper::add_typography_group( $this, 'info_typography', '{{WRAPPER}} .bw-slide-showcase-info, {{WRAPPER}} .bw-slide-showcase-info-item' );
		...
		BW_Widget_Helper::add_typography_group( $this, 'badge_typography', '{{WRAPPER}} .bw-slide-showcase-badge' );

		BW_Widget_Helper::add_dimensions_control( $this, 'badge_padding', __( 'Padding', 'bw-elementor-widgets' ), '{{WRAPPER}} .bw-slide-showcase-badge', 'padding', array( 'px', '%', 'em', 'rem' ) );
		...
		BW_Widget_Helper::add_typography_group( $this, 'button_typography', '{{WRAPPER}} .bw-slide-showcase-view-btn' );

		BW_Widget_Helper::add_dimensions_control( $this, 'button_padding', __( 'Padding', 'bw-elementor-widgets' ), '{{WRAPPER}} .bw-slide-showcase-view-btn', 'padding', array( 'px', '%', 'em', 'rem' ) );

		BW_Widget_Helper::add_dimensions_control(
			$this,
			'button_border_radius',
			__( 'Border Radius', 'bw-elementor-widgets' ),
			'{{WRAPPER}} .bw-slide-showcase-view-btn',
			'border-radius',
			array( 'px', '%' ),
			array(
				'top'    => 8,
	...
	protected function render() {
		...
		if ( ! in_array( $product_type_value, array( 'digital', 'physical' ), true ) ) {
		...
		$container_classes = array( 'bw-static-showcase-container' );
		if ( ! $image_crop ) {
