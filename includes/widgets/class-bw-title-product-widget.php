	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'label_block' => true,
				'condition'   => array( 'title_source' => 'product' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'label_block' => true,
				'condition'   => array( 'title_source' => 'text' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'label_block' => true,
				'condition'   => array( 'title_source' => 'page' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'label_block' => true,
				'condition'   => array( 'title_source' => 'category' ),
			)
		);
		...
		$this->start_controls_section(
			'section_style_responsive_title',
			array(
