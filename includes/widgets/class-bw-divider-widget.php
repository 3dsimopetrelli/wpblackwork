...
class Widget_Bw_Divider extends Widget_Base {
	...
	protected function register_controls() {
		...
		BW_Widget_Helper::add_color_var_control( $this, 'line_color', __( 'Line Color', 'bw-elementor-widgets' ), '{{WRAPPER}} .bw-divider', '--divider-color', '#000000' );
	...
	private function get_plugin_main_file() {
		return dirname( __DIR__, 2 ) . '/blackwork-core-plugin.php';
	}
}
