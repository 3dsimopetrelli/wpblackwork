...
class BW_Go_To_App_Widget extends Widget_Base {
	...
	public function get_style_depends() {
		...
		return array( 'bw-go-to-app-style' );
	}
	...
	protected function register_controls() {
		...
		BW_Widget_Helper::add_typography_group( $this, 'content_typography', '{{WRAPPER}} .bw-go-to-app__text' );
		...
		BW_Widget_Helper::add_typography_group( $this, 'button_typography', '{{WRAPPER}} .bw-go-to-app__button-label' );
	...
	protected function render() {
		...
		$link        = ! empty( $settings['button_link']['url'] ) ? $settings['button_link'] : array();
