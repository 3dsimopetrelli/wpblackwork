...
class BW_Apple_Pay_Gateway extends BW_Abstract_Stripe_Gateway {
	...
	public function get_icon() {
		return '<span class="bw-payment-method__applepay-logo" role="img" aria-label="' . esc_attr__( 'Apple Pay', 'bw' ) . '"><span class="bw-payment-method__applepay-mark">Apple Pay</span></span>';
	}
