...
class BW_Klarna_Gateway extends BW_Abstract_Stripe_Gateway {
	...
	public function get_icon() {
		...
		$klarna_logo_data = 'data:image/svg+xml;base64,' . base64_encode( $klarna_svg );

		return '<img class="bw-payment-method__klarna-logo" src="' . esc_attr( $klarna_logo_data ) . '" alt="' . esc_attr__( 'Klarna', 'bw' ) . '" loading="lazy" decoding="async" />';
	}
