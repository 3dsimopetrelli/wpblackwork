...
>
    ...
    <?php if ( ! empty( $view['hide_widget'] ) && ! empty( $view['is_editor'] ) ) : ?>
        <div class="bw-reviews__editor-empty-note">
            <?php echo esc_html( (string) $view['editor_empty_notice'] ); ?>
        </div>
    ...
    <?php elseif ( empty( $view['hide_widget'] ) ) : ?>
        <div class="bw-reviews__shell<?php echo empty( $view['has_reviews'] ) ? ' is-empty' : ''; ?>">
            ...
            <div class="bw-reviews-grid" data-review-grid>
                <?php echo wp_kses_post( (string) $view['reviews_html'] ); ?>
            </div>
