...
function bw_fpw_generate_cache_key($params)
{
    ...
    $canonical_payload = [
        ...
        'sort_key' => bw_fpw_normalize_sort_key(isset($params['sort_key']) ? $params['sort_key'] : (function_exists('bw_fpw_get_discovery_sort_default_key') ? bw_fpw_get_discovery_sort_default_key() : 'random_seeded')),
...
function bw_fpw_build_engine_cache_key($request)
{
    return bw_fpw_generate_cache_key([
        ...
        'sort_key' => bw_fpw_normalize_sort_key(isset($request['sort_key']) ? $request['sort_key'] : (function_exists('bw_fpw_get_discovery_sort_default_key') ? bw_fpw_get_discovery_sort_default_key() : 'random_seeded')),
