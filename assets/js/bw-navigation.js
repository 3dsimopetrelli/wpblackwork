(function () {
    ...
    function initNavigationInScope(scope) {
        var root = getRootFromScope(scope);
        if (!root) {
            return;
        }

        var instances = root.querySelectorAll('.bw-navigation');
    ...
    function initAll() {
        document.querySelectorAll('.elementor-widget-bw-navigation').forEach(function (widget) {
            initNavigationInScope(widget);
        });
    }
    ...
    window.addEventListener('elementor/frontend/init', function () {
        ...
        window.elementorFrontend.hooks.addAction('frontend/element_ready/bw-navigation.default', function (scope) {
            initNavigationInScope(scope);
        });
    });
})();
