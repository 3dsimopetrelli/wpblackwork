...
class SAS_Product_Review extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Reviews', 'sas' );
	}
	...
	protected function render() {
		...
		<div id="reviews" class="woocommerce-Reviews">
				...
				<div id="review_form_wrapper">
					<div id="review_form">
						...
						$comment_form = array(
							...
							'title_reply'         => have_comments() ? esc_html__( 'Add a review', 'woocommerce' ) : sprintf( esc_html__( '', 'woocommerce' ), get_the_title() ),
							/* translators: %s is product title */
			...
			<?php else : ?>
				<p class="woocommerce-verification-required"><?php esc_html_e( 'Reviews are exclusively open to customers who have purchased this product
.', 'woocommerce' ); ?></p>
			<?php endif; ?>
