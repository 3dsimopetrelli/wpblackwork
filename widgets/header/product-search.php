...
class Product_Search_Form extends \Elementor\Widget_Base {

	public function get_name() {
		return 'sas-search-form';
	}

	public function get_title() {
		return esc_html__( 'Product Search Form', 'elementor-pro' );
	}
	...
	public function get_style_depends() {
		if ( Icons_Manager::is_migration_allowed() ) {
			return [ 'elementor-icons-fa-solid', 'sas-search' ];
		}
		return [ 'sas-search' ];
	}
	...
	protected function render() {
		...
		<form class="elementor-search-form" role="search" action="<?php // PHPCS - the method home_url is safe.
			...
			<div class="elementor-search-form__container">
				...
				<input <?php $this->print_render_attribute_string( 'input_hidden' ); ?>>
				<?php
				/**
